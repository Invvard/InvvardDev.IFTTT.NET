...
public static class KeyedServiceExtensions
{
    ...
    private sealed class KeyedServiceDictionary<TKey, TService>(KeyedServiceCache<TKey, TService> keys, IServiceProvider provider)
    ...
    private sealed class KeyedServiceCache<TKey, TService>(IServiceCollection services)
        where TKey : notnull
        where TService : notnull
    {
        ...
        public TKey[] Keys { get; } = (from service in services
